...
gallery/waterfallx/1.0/base
gallery/waterfallx/1.0/loader
gallery/waterfallx/1.0/index
...
;
KISSY.add('gallery/waterfallx/1.0/base',function (S, Node, D) {
    var $ = Node.all,
//        D = S.DOM,
    ...
    var privatePro = {
        ...
        _createColumnItems: function () {
            ...
            for (i = 0; i < colCount; ++i) {
                colItems[i] = $(doc.createElement('div')).
                    addClass(COLCLASS).appendTo(this.container)
...
//            margin /= colCount
    ...
    var pulbicPro = {
        ...
        removeItem: function (item, cfg) {
            ...
            if (effect) {
                item.animate(effect.effect, effect.duration, effect.easing, callback)
            } else {
                callback()
            }
        },
        ...
        adjust: function (callback) {
            ...
            this._preItems = []
            for (var i = 0, len = items.length; i < len; /*empty*/) {
                //停止动画,去除空洞
                if (items[i]) {
        ...
        S.extend(Loader, Waterfall,
             ...
             */
            {
                ...
                start: function () {
                    ...
                    !this.__started && $(win).on("scroll", this.__onScroll) && (this.__started = 1)
                },
...
;
KISSY.add('gallery/waterfallx/1.0/index',function (S, WaterfallX, Loader) {
